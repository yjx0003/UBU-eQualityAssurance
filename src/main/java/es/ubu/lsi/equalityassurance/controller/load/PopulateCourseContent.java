...
import es.ubu.lsi.moodlerestapi.webservice.api.core.course.CoreCourseGetContents;
...
public class PopulateCourseContent {
	...
	public Pair<List<Section>, List<CourseModule>> populateCourseContent(int courseid) {
		...
		try {
			...
			JSONArray jsonArray = UtilResponse.getJSONArrayResponse(webService, coreCourseGetContents);
